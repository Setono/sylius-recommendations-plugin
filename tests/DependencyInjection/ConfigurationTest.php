...
use Setono\SyliusRecommendationsPlugin\DependencyInjection\Configuration;
...
final class ConfigurationTest extends TestCase
{
    ...
    public function values_are_invalid_if_required_value_is_not_provided(): void
    {
        $this->assertConfigurationIsInvalid(
            ...
            '/The child (config|node) "option" (under|at path) "setono_sylius_recommendations" must be configured/',
            true,
        );
    }
